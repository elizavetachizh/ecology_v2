...
export const REPORTS: Record<ReportId, ReportDefinition> = {
  pod9: {
    ...
    pageDescription:
      "Журнал учёта движения отходов: место учёта и период. Отходы берутся из привязок, в строки — подтверждённые операции.",
    formDescription:
      "Выберите место учёта ПОД-9. Период ограничивает операции в таблицах листов.",
