...
export const contractFormSchema = z
  .object({
    ...
    counterparty_id: z.uuid("Выберите контрагента"),
    counterparty_address: z.string().max(255, "Не более 255 символов"),
    counterparty_contact: z.string().max(255, "Не более 255 символов"),
